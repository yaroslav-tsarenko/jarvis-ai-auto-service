...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/all-user-loads')
            .then(response => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/get-heavy-equipment-loads')
            .then(response => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/get-construction-equipment-loads')
            .then(response => {
                if (response.data && response.status === 200) {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/get-boat-loads')
            .then(response => {
                if (response.data && response.status === 200) {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8080/submit-vehicle-load/${personalEndpoint}`)
            .then(response => {
                if (response.data && response.status === 200) {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/get-moto-equipment-loads')
            .then(response => {
                if (response.data && response.status === 200) {
